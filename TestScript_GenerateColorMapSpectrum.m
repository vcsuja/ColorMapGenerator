...
axis on
box off
set(gca,'Xticklabel',[],'Yticklabel',[],'Position',[0.2453 0.7673 0.5443 0.1856]);
%% Plot RGB
hs2=subplot(numPlots,1,2);
plot(0:5000/numColors:5000,ColorMap(1,:,1),'r');
hold on
plot(0:5000/numColors:5000,ColorMap(1,:,2),'g');
plot(0:5000/numColors:5000,ColorMap(1,:,3),'b');
set(gca,'Xticklabel',[],'Position',[0.2453 0.5438 0.5443 0.1856]);
title(hs2,'RGB');
legend('R','G','B','Orientation','horizontal')
%% Plot HSV
HSVColorMap=rgb2hsv(ColorMap);
hs3=subplot(numPlots,1,3);
plot(0:5000/numColors:5000,HSVColorMap(1,:,1),'r');
hold on
plot(0:5000/numColors:5000,HSVColorMap(1,:,2),'g');
plot(0:5000/numColors:5000,HSVColorMap(1,:,3),'b');
set(hs3,'Xticklabel',[],'Position',[0.2453 0.3230  0.5443 0.1856]);
title(hs3,'HSV');
...
plot(0:5000/numColors:5000,LabColorMap(1,:,1),'r');
hold on
plot(0:5000/numColors:5000,LabColorMap(1,:,2),'g');
plot(0:5000/numColors:5000,LabColorMap(1,:,3),'b');
set(gca,'Position',[0.2453 0.1 0.5443 0.1856]);
title(hs4,'L*a*b');
